...
PAGE 0 :
   ...
   RAML0123   : origin = 0x008000, length = 0x004000    
/*   RAML1      : origin = 0x009000, length = 0x001000    
   RAML2      : origin = 0x00A000, length = 0x001000    
   RAML3      : origin = 0x00B000, length = 0x001000 */
   ZONE7A     : origin = 0x200000, length = 0x00FB00    /* XINTF zone 7 - program space */ 
...
SECTIONS
{
   ...
   .text            : > RAML0123,    	PAGE = 0
   .cinit           : > RAML4,    		PAGE = 1
   .pinit           : > RAML0123,     	PAGE = 0
   .switch          : > RAML0123,     	PAGE = 0
   
   initzone			: > RAML0123,	  	PAGE = 0

   .stack           : > RAML4,    	 	PAGE = 1
   .ebss            : > RAML567,     	PAGE = 1
   .econst          : > RAML567,   		PAGE = 1      
